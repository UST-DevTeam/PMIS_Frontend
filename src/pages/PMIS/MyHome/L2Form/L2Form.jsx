...
import L2FormFORM from "../../../../pages/PMIS/MyHome/L2Form/L2FormFORM";
...
const L2Form = () => {
  ...
  let dbConfigList = useSelector((state) => {
    let interdata = state?.expenseAdvanceData?.getL2Data || [""];
            ...
            child={
              <EditButton
                ...
                onClick={() => {
                  ...
                  setmodalHead("Edit L2 Expense Approval");
                  setmodalBody(
                    <>
                      <L2FormFORM
                        isOpen={modalOpen}
                        ...
                        onClick={() => {
                          dispatch(
                            CommonActions.deleteApiCaller(
                              `${Urls.expAdv_L2Data}/${itm.uniqueId}`,
                              () => {
                                dispatch(ExpenseAdvanceActions.getL2Data());
