...
const OtherFixedCostTypesForm = ({ isOpen, setIsOpen, resetting, formValue = {} }) => {
    ...
    const onTableViewSubmit = (data) => {
        if (formValue.uniqueId) {
            dispatch(gpTrackingActions.postOtherFixedCostTypes(true,data, () => {
                setIsOpen(false)
...
export default OtherFixedCostTypesForm;