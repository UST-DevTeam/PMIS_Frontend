...
const CumulativeWorkdonePlanVsActual = () => {
  ...
  return (
    <div className="bg-transparent border-[1.5px] border-pcol rounded-md h-full p-4">
         <div className="text-center mb-4">
            <h1 className="text-[#f4d3a8] font-bold text-lg whitespace-nowrap underline">Cumulative - Plan VS Actual Workdone</h1>
        </div>
      ...
      <BarLineGraph data={GraphData} headerName={"Cumulative_Plan_VS_Actual_Workdone"} seriesData={SeriesData} horizontal={false} YAxisTextTitle ="Planned" dataLabelSuffix="L" data1= {data1} data2= {data2} data3= {SecondaryAxis}/>
    </div>
  );
};
