...
import { GET_GRAPH_PHY_MS1_VS_MS2 } from "../../../store/reducers/graph-reducer";
...
const PHYMS1VsMS2 = () => {
  ...
  const handleFilter = () => {
    ...
    dispatch(GraphActions.postGraphphyMS1vsMS2(filterData, () => {}));
  };
  ...
  return (
    <div className="bg-transparent border-[1.5px] border-pcol rounded-md w-auto p-4">
      ...
      <BarGraph data={GraphData} headerName={"PHY_MS1_Vs_MS2"} seriesData={seriesData} horizontal={false}  columnWidth='60%' />
    </div>
  );
};
