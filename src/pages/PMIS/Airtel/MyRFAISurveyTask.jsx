...
import { GET_AIRTEL_USER_ALLLOCATED_PROJECT } from '../../../store/reducers/airtel-reducer';
import RFAIPlanningDataForm from './RFAIPlanningDataForm';
import SearchBarView from '../../../components/SearchBarView';

const MyRFAISurveyTask = () => {
    ...
    let dbConfigList = useSelector((state) => {
        let interdata = state?.airtelData?.getAirtelMyRFAISurveyTask || [""]
    ...
    const onSubmit = (data) => {
        ...
        delete data.reseter
        dispatch(AirtelActions.getAirtelMyRFAISurveyTask(value, objectToQueryString(data)))
    }

    useEffect(() => {
        dispatch(AirtelActions.getAirtelMyRFAISurveyTask())
    }, [])
    ...
    const handleSearch = (value) => {
        dispatch(AirtelActions.getAirtelMyRFAISurveyTask(true,value !== "" ? "searvhView=" + value : ""))
    };
    ...
    return <>
        <AdvancedTable
            ...
            headerButton={
                ...
                //         dispatch(CommonActions.commondownload("/export/airtelRFAIOffered","Export_RFAI_Offered.xlsx"))
                //         }}>
                //     </Button>
...
export default MyRFAISurveyTask;