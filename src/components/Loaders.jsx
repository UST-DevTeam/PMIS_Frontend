...
export const Loaders = () => {
    ...
    return <>
        ...
        {
            swAlerts ?
                <div className='h-full z-[100000] absolute w-full flex justify-center items-center bg-gray-500 bg-opacity-50'>
                    {/* <div class="loader1">
                    <span class="bar"></span>
                    <span class="bar"></span>
                    <span class="bar"></span> */}
                        {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 80" preserveAspectRatio="xMidYMid" class="lds-infinity stroke-yellow-400">
