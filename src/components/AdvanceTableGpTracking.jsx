  ...
  return (
    <>
      <div className="absolute left-0 right-0 flex-col">
        ...
        <div className={`m-2 overflow-x-auto ${TableHeight} pb-2 sm:pb-44 xl:pb-2  border-1 border-solid border-black rounded-lg`}>
                      ...
                      <>
                        {actions.includes(itts.name) ? (
                          ...
                          <>
                            ...
                            >
                              <span className="text-black-600 text-[13px]">
                                {itts.name}
                              </span>
                            </th>
                          </>
